// In this file we are copying all the genres we are getting for the request, and pasting
// them here in order to have them in a file, instead of making an HTTP request.
export default [
  {
    'id': 4,
    'name': 'Action',
